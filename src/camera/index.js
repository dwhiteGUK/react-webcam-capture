...
export function Camera({ onCapture, onClear }) {
  ...
  if (!mediaStream) {
    console.log('Camera -> mediaStream', mediaStream);
    return null;
  }
        ...
        <div className="flex flex-col items-center w-full">
          <div
            ...
            style={{
              ...
              "max-width": `${videoRef.current && videoRef.current.videoWidth}px`,
              "max-height": `${videoRef.current && videoRef.current.videoHeight}px`
            }}
          >
            <video
